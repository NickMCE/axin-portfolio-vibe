  ...
  return (
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary to-secondary p-4">
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
        <div className="w-full md:w-1/2 animate-slide-in flex items-center justify-center">
          <img
            src="/lovable-uploads/1d96ce01-53ad-4145-97f9-c52fd7b553ad.png"
            alt="Axin Ricco"
            className="w-[32rem] h-[32rem] rounded-full mx-auto md:mx-0 object-cover border-4 border-primary-accent/20 shadow-xl hover:scale-105 transition-transform duration-300"
          />
        </div>
